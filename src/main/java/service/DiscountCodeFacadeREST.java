...
import com.udea.pruebarest.entity.DiscountCode;
 ...
 */
@Stateless
@Path("com.udea.pruebarest.entity.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.udea_PruebaRest_war_1.0-SNAPSHOTPU")
